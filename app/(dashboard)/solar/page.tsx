  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-semibold text-gray-900">Solar & Equipos</h1>
          <p className="text-sm text-gray-500">Instalación y venta de sistemas solares</p>
        </div>
      </div>
          ...
          {tasks.length === 0 ? (
            ...
            tasks.map((task) => (
              <div key={task.id} className="flex items-center gap-3 p-3">
                <div className={`w-2 h-2 rounded-full ${task.status === 'done' ? 'bg-green-400' : 'bg-yellow-400'}`} />
